          ...
          new mapboxgl.Marker({
            ...
            .setPopup(
              ...
              .setHTML(`<div>
                ...
                <a href="${process.env.REACT_APP_BLINDS_URL}/screen/${marker?.properties?.screen}/${marker?.properties?.image?.split('/').slice(-1)[0]}/${marker?.properties?.activeGame}" fontweight="600">Click her for screen details</a>
              </div>`)
          ).addTo(map);
        })
      });
